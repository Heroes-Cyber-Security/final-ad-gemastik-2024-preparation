...
echo "PostUp = iptables -t nat -I POSTROUTING -o eth1 -j MASQUERADE" >> wg0.conf
...
echo "PostDown = iptables -t nat -D POSTROUTING -o eth1 -j MASQUERADE" >> wg0.conf
...
for ((i=1; i<=$teams; i++)); do
    ...
    for ((j=1; j<=$clients_per_team; j++)); do
        ...
        echo "AllowedIPs = 10.80.$i.$j/32, 10.104.0.0/20" >> wg0.conf
        echo "" >> wg0.conf
        ...
        echo "AllowedIPs = 10.0.0.0/8, 10.104.0.0/20" >> $client_conf
